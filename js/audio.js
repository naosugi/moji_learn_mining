class AudioController {
    ...
    playSE(type) {
        ...
        switch (type) {
            ...
            case 'correct':
                // Fanfare-ish: C - E - G (use playTone, discard unused shared osc)
                osc.start(now);
                osc.stop(now);
            ...
            case 'sparkle':
                // Magic chime (use playTone, discard unused shared osc)
                osc.start(now);
                osc.stop(now);
            ...
            case 'pollen':
                // Very high pitch small twinkle (use playTone, discard unused shared osc)
                osc.start(now);
                osc.stop(now);
